...
# field_.create_field()
# pickle.dump(field_, open('/home/amy/projects/FEA/refactoring/utilities/saved_fields/Henrys.pickle', 'wb'))
field_1 = Field()
print('35MID')
...
pickle.dump(field_1, open('/home/amy/projects/FEA/refactoring/utilities/saved_fields/sec35mid.pickle', 'wb'))
# field_2 = Field()
# print('35WEST')
