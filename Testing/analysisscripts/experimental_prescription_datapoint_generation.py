...
"""
create CSV file of datapoints with found prescribed fertilizer for the experimental maps.
This needs to be done so the CSV file can be used by the CNN or RF to predict yield.
"""
