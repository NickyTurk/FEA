...
reduced_agg_files = ["C:/Users/f24n127/Documents/Work/Ag/Data/aggregated_data/reduced_henrys_agg.csv"] #reduced_henrys_agg.csv  reduced_broyles_sec35mid_agg

for i, field in enumerate(fields_to_test):
    df = pd.read_csv(agg_files[i])
    y_labels = df['yl18_bu_ac'] #yl18_bu_ac
