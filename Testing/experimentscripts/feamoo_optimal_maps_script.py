...
agg_files = ["C:/Users/f24n127/Documents/Work/Ag/Data/aggregated_data/wood_henrys_yl18_aggreg_20181203.csv"] # wood_henrys_yl18_aggreg_20181203.csv broyles_sec35mid_2016_yl_aggreg_20181112.csv
reduced_agg_files = ["C:/Users/f24n127/Documents/Work/Ag/Data/reduced_wood_henrys_aggregate.csv"] #reduced_wood_henrys_aggregate.csv  reduced_broyles_sec35mid_aggregate
...
for i, field in enumerate(fields_to_test):
    ...
    for j in range(5):
        start = time.time()
        filename = path + '/results/prescriptions/RF_optimized/SNSGA2_' + field_names[i] + '_strip_trial_3_objectives_ga_runs_' + str(ga_run) + '_population_' + str(population_size) + time.strftime('_%d%m%H%M%S') + '.pickle'
