...
yld_data_to_use = [
    ...
    "ndwi_py_s_2020",
    "bm_wd_2020",
    "carboncontent10cm_2020",
    "phw10cm_2020",
    "watercontent10cm_2020",
    "sandcontent10cm_2020",
    "claycontent10cm_2020",
    "aa_sr_2021",
    "ndvi_py_s_2021",
    "ndwi_py_s_2021",
    "bm_wd_2021",
    "carboncontent10cm_2021",
    "phw10cm_2021",
    "watercontent10cm_2021",
    "sandcontent10cm_2021",
    "claycontent10cm_2021",
]
...
yp = YieldPredictor(
    prescription=pr,
    field=field,
    agg_data_file=reduced_agg_file,
    trained_model=rf_yld,
    weeds_model=rf_weeds,
    data_headers=yld_data_to_use,
    weeds_headers=wds_data_to_use,
)
...
for j in range(5):
    for population in population_sizes:
        for ga_run in ga_runs:
            ...
            filename = (
                path
                + "/results/prescriptions/optimized/SPEA2_millview_trial_organic_objectives_ga_runs_"
                + str(ga_run)
                + "_population_"
                + str(population)
