...
class GA:
    ...
    def tournament_selection(self, population):
        ...
        while i < self.tournament_size:
            ...
            if curr_fitness:
                if temp.fitness.all() <= curr_fitness.all():
    ...
    def mutate(self, original_solution):
        ...
        """
        rand = random.random()
        _solution = [x for x in original_solution.variables]
    ...
    def crossover(self, first_solution, second_solution):
        ...
        if random.random() < self.crossover_rate:
            _first_solution = [x for x in first_solution.variables]
            _second_solution = [x for x in second_solution.variables]
    ...
    def create_offspring(self, curr_population):
        ...
        while j < self.offspring_size:
            ...
            if crossed_over:
                ...
                child1 = [x for x in first_solution.variables]
                child2 = [x for x in second_solution.variables]
