...
if __name__ == '__main__':
    ...
    data_to_use = ['x', 'y', 'n_lbs_ac', 'elev_m', 'slope_deg', 'ndvi_2012', 'ndvi_2014', 'ndvi_2015', 'yl14_nn_bu_ac',
     'n15_lbs_ac', 'n14_lbs_ac', 'yl_2016']
    agg_file = "C:/Users/f24n127/Documents/Work/Ag/Data/broyles_sec35mid_2016_yl_aggreg_20181112.csv"
    field = pickle.load(open(path + '/refactoring/utilities/saved_fields/sec35mid.pickle', 'rb'))
    reduced = reduce_dataframe(field, data_to_use, agg_file, transform_to_latlon=True)
    reduced.to_csv("C:/Users/f24n127/Documents/Work/Ag/Data/reduced_5_broyles_sec35mid_agg.csv")